                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex gap-2">
                                        <button wire:click="openModal({{ json_encode($stat) }})" class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg" title="Edit"><i class="bi bi-pencil"></i></button>
                                        <button wire:click="confirmDelete('{{ $stat['id'] }}')" class="p-2 text-red-600 hover:bg-red-50 rounded-lg" title="Delete"><i class="bi bi-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
        ...
        <div class="flex min-h-screen items-center justify-center p-4">
            ...
            <div class="relative bg-white rounded-xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto scrollbar-light" @click.stop>
                <div class="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center">
                    <h3 class="text-xl font-semibold text-gray-900">{{ $editingStat ? 'Edit Global Stat' : 'Add Global Stat' }}</h3>
    ...
    <div x-show="showDeleteModal" x-cloak class="fixed inset-0 bg-black/50 flex items-center justify-center z-[9999]">
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-6">
            <div class="text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">Delete Global Stat?</h3>
                <p class="text-gray-600 mb-6">This will remove this stat from all sections where it appears.</p>
                <div class="flex gap-3 justify-center">
                    <button @click="showDeleteModal = false" class="px-5 py-2.5 border border-gray-300 text-gray-700 rounded-lg">Cancel</button>
