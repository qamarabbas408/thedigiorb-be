...
class DatabaseSeeder extends Seeder
{
    ...
    {
        $globalStats = [
            ['id' => 'gs_1', 'key' => 'projects_delivered', 'label' => 'Projects Delivered', 'value' => '150+', 'icon' => 'bi-briefcase', 'display_order' => 1, 'status' => 'published', 'sections' => ['hero', 'services', 'team']],
            ...
            ['id' => 'gs_3', 'key' => 'years_experience', 'label' => 'Years Experience', 'value' => '12+', 'icon' => 'bi-calendar', 'display_order' => 3, 'status' => 'published', 'sections' => ['hero', 'about', 'services', 'team']],
            ['id' => 'gs_4', 'key' => 'team_experts', 'label' => 'Team Experts', 'value' => '40+', 'icon' => 'bi-people', 'display_order' => 4, 'status' => 'published', 'sections' => ['hero', 'team']],
    ...
    private function seedServices()
    {
        $services = [
            ...
            ['id' => '7', 'title' => 'Data Analytics', 'description' => 'Transform your data into actionable insights with advanced analytics, reporting, and visualization solutions.', 'icon' => 'bi-graph-up-arrow', 'featured' => false, 'display_order' => 7, 'status' => 'published'],
            ['id' => '8', 'title' => 'Cybersecurity', 'description' => 'Protect your business with comprehensive security audits, penetration testing, and vulnerability assessments.', 'icon' => 'bi-shield-check', 'featured' => false, 'display_order' => 8, 'status' => 'published'],
            ['id' => '9', 'title' => 'Blockchain Development', 'description' => 'Innovative blockchain solutions including smart contracts, decentralized apps, and cryptocurrency integration.', 'icon' => 'bi-link-45deg', 'featured' => false, 'display_order' => 9, 'status' => 'published'],
            ['id' => '10', 'title' => 'AI & Machine Learning', 'description' => 'Cutting-edge AI solutions including predictive models, natural language processing, and computer vision applications.', 'icon' => 'bi-robot', 'featured' => false, 'display_order' => 10, 'status' => 'published'],
            ['id' => '11', 'title' => 'IT Consulting', 'description' => 'Expert IT consulting services to help you transform your business operations and achieve digital transformation.', 'icon' => 'bi-chat-dots', 'featured' => false, 'display_order' => 11, 'status' => 'published'],
            ['id' => '12', 'title' => 'Custom Software', 'description' => 'Bespoke software solutions tailored to your specific business needs and requirements.', 'icon' => 'bi-gear', 'featured' => false, 'display_order' => 12, 'status' => 'published'],
            ['id' => '13', 'title' => 'Technical Support', 'description' => '24/7 technical support and maintenance services to keep your systems running smoothly.', 'icon' => 'bi-headset', 'featured' => false, 'display_order' => 13, 'status' => 'published'],
            ['id' => '14', 'title' => 'DevOps Services', 'description' => 'Streamline your development with CI/CD pipelines, containerization, and automated deployment solutions.', 'icon' => 'bi-hdd', 'featured' => false, 'display_order' => 14, 'status' => 'published'],
            ['id' => '15', 'title' => 'API Development', 'description' => 'Robust and scalable API development and integration services for seamless connectivity.', 'icon' => 'bi-plug', 'featured' => false, 'display_order' => 15, 'status' => 'published'],
        ];
    ...
    private function seedTeamMembers()
    {
        $members = [
            ...
            ['id' => '5', 'name' => 'Ahmed Khan', 'role' => 'Senior Backend Developer', 'bio' => 'Expert in Laravel, Node.js, and Python with 6+ years of experience in building robust APIs and microservices architectures.', 'image' => '', 'display_order' => 5, 'status' => 'active'],
            ['id' => '6', 'name' => 'Sara Ali', 'role' => 'Frontend Developer', 'bio' => 'Specializes in React, Next.js, and Vue.js with a passion for creating responsive and accessible user interfaces.', 'image' => '', 'display_order' => 6, 'status' => 'active'],
            ['id' => '7', 'name' => 'Bilal Ahmed', 'role' => 'Mobile App Developer', 'bio' => 'Expert in Flutter and React Native for cross-platform mobile development. Has delivered 20+ mobile apps to clients worldwide.', 'image' => '', 'display_order' => 7, 'status' => 'active'],
            ['id' => '8', 'name' => 'Fatima Rashid', 'role' => 'UI/UX Designer', 'bio' => 'Creative designer with expertise in Figma, Adobe XD, and prototyping. Focused on creating user-centered designs.', 'image' => '', 'display_order' => 8, 'status' => 'active'],
            ['id' => '9', 'name' => 'Imran Saeed', 'role' => 'DevOps Engineer', 'bio' => 'AWS certified specialist in CI/CD pipelines, Docker, Kubernetes, and cloud infrastructure management.', 'image' => '', 'display_order' => 9, 'status' => 'active'],
            ['id' => '10', 'name' => 'Aisha Malik', 'role' => 'Digital Marketing Specialist', 'bio' => 'SEO and social media expert with proven track record of increasing organic traffic and engagement for clients.', 'image' => '', 'display_order' => 10, 'status' => 'active'],
            ['id' => '11', 'name' => 'Omar Farooq', 'role' => 'Data Analyst', 'bio' => 'Proficient in Python, SQL, and data visualization tools. Helps businesses make data-driven decisions.', 'image' => '', 'display_order' => 11, 'status' => 'active'],
            ['id' => '12', 'name' => 'Nida Khan', 'role' => 'Quality Assurance Engineer', 'bio' => 'Experienced in manual and automated testing, ensuring high-quality software deliverables.', 'image' => '', 'display_order' => 12, 'status' => 'active'],
            ['id' => '13', 'name' => 'Usman Ali', 'role' => 'Project Manager', 'bio' => 'Certified PMP with expertise in Agile methodologies and team coordination.', 'image' => '', 'display_order' => 13, 'status' => 'active'],
            ['id' => '14', 'name' => 'Hira Sheikh', 'role' => 'Content Writer', 'bio' => 'Creative content creator specializing in technical writing, blog posts, and marketing copy.', 'image' => '', 'display_order' => 14, 'status' => 'active'],
            ['id' => '15', 'name' => 'Danish Rana', 'role' => 'Cybersecurity Analyst', 'bio' => 'Expert in penetration testing, vulnerability assessment, and security audits.', 'image' => '', 'display_order' => 15, 'status' => 'active'],
        ];
    ...
    private function seedTestimonials()
    {
        $testimonials = [
            ...
            ['id' => '4', 'name' => 'John D.', 'title' => 'CTO', 'company' => 'FinanceHub', 'content' => 'The team at DigitalOrbit delivered an exceptional fintech solution that transformed our operations. Their attention to detail and security measures were outstanding.', 'rating' => 5, 'image' => '', 'featured' => true, 'status' => 'published'],
            ['id' => '5', 'name' => 'Lisa M.', 'title' => 'Marketing Head', 'company' => 'BrandBuilders', 'content' => 'Our new website from DigitalOrbit has significantly improved our conversion rates. The design is beautiful and the user experience is smooth.', 'rating' => 4, 'image' => '', 'featured' => false, 'status' => 'published'],
            ['id' => '6', 'name' => 'David P.', 'title' => 'Founder', 'company' => 'StartupHub', 'content' => 'DigitalOrbit helped us launch our MVP in record time. Their agile approach and technical skills are exceptional. Highly recommended!', 'rating' => 5, 'image' => '', 'featured' => true, 'status' => 'published'],
            ['id' => '7', 'name' => 'Anna S.', 'title' => 'Operations Manager', 'company' => 'LogiTech', 'content' => 'The warehouse management system developed by DigitalOrbit has streamlined our entire supply chain. Great teamwork and communication throughout.', 'rating' => 5, 'image' => '', 'featured' => false, 'status' => 'published'],
            ['id' => '8', 'name' => 'Michael W.', 'title' => 'Director', 'company' => 'HealthPlus', 'content' => 'DigitalOrbit built our patient management system with such precision. They understood our requirements perfectly and delivered beyond expectations.', 'rating' => 5, 'image' => '', 'featured' => true, 'status' => 'published'],
            ['id' => '9', 'name' => 'Jennifer L.', 'title' => 'CEO', 'company' => 'EduLearn', 'content' => 'The e-learning platform developed by DigitalOrbit has revolutionized how we deliver courses. Students love the interactive features.', 'rating' => 4, 'image' => '', 'featured' => false, 'status' => 'published'],
            ['id' => '10', 'name' => 'Robert H.', 'title' => 'Manager', 'company' => 'AutoDrive', 'content' => 'Our car dealership website is now the top in the region thanks to DigitalOrbit. Great SEO results and user-friendly design.', 'rating' => 5, 'image' => '', 'featured' => false, 'status' => 'published'],
            ['id' => '11', 'name' => 'Sophie T.', 'title' => 'Head of Design', 'company' => 'ArtFlow', 'content' => 'Working with DigitalOrbit on our portfolio site was fantastic. They captured our brand essence perfectly.', 'rating' => 5, 'image' => '', 'featured' => true, 'status' => 'published'],
            ['id' => '12', 'name' => 'James K.', 'title' => 'Business Owner', 'company' => 'LocalShop', 'content' => 'DigitalOrbit helped take our local business online. Sales have increased by 40% since the launch. Excellent service!', 'rating' => 5, 'image' => '', 'featured' => false, 'status' => 'published'],
            ['id' => '13', 'name' => 'Maria G.', 'title' => 'VP Engineering', 'company' => 'CloudTech', 'content' => 'The cloud migration handled by DigitalOrbit was flawless. Zero downtime and improved performance significantly.', 'rating' => 5, 'image' => '', 'featured' => true, 'status' => 'published'],
            ['id' => '14', 'name' => 'Tom B.', 'title' => 'CEO', 'company' => 'FoodieApp', 'content' => 'Our food delivery app is a huge success! DigitalOrbit\'s team was professional, responsive, and delivered on time.', 'rating' => 4, 'image' => '', 'featured' => false, 'status' => 'published'],
            ['id' => '15', 'name' => 'Rachel N.', 'title' => 'Director', 'company' => 'TravelEase', 'content' => 'The booking platform DigitalOrbit built for us handles thousands of bookings daily without any issues. Highly reliable!', 'rating' => 5, 'image' => '', 'featured' => true, 'status' => 'published'],
        ];
