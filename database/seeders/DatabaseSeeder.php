...
class DatabaseSeeder extends Seeder
{
    ...
    {
        $members = [
            ['id' => '1', 'name' => 'Qamar Abbas', 'role' => 'Founder & CEO', 'bio' => 'Full-Stack Developer, React JS, Flutter, React Native, Swift, Laravel, Django. 5+ years of experience working with multinational clients, delivering scalable web and mobile solutions.', 'image' => '/assets/img/team/person-m-1.webp', 'display_order' => 1, 'status' => 'active'],
            ['id' => '2', 'name' => 'Sunail Abbas', 'role' => 'Co-Founder & Tech Lead', 'bio' => 'Developer, Full-Stack, Laravel, React JS, Flutter. 5+ years of experience building solutions for government departments, with a focus on reliability and efficiency.', 'image' => '/assets/img/team/person-m-3.webp', 'display_order' => 2, 'status' => 'active'],
            ['id' => '3', 'name' => 'Zafar Mirza', 'role' => 'Creative Director, UI/UX', 'bio' => 'A visionary UI/UX designer passionate about creating intuitive and engaging digital experiences. Skilled in user research, wireframing, prototyping, and visual design.', 'image' => '/assets/img/team/person-m-5.webp', 'display_order' => 3, 'status' => 'active'],
            ['id' => '4', 'name' => 'Tashmina Mehr', 'role' => 'Marketing Director, Marketing / SEO', 'bio' => 'A results-driven marketing expert specializing in digital strategy and SEO. Tashmina develops and executes innovative marketing campaigns to drive brand awareness.', 'image' => '/assets/img/team/person-f-2.webp', 'display_order' => 4, 'status' => 'active'],
        ];
